...
if __name__ == '__main__':
    with open("results_hamming.txt", "w", encoding="utf-8") as result_file:
        with open("Sequence_1.txt", "r") as file:
            ...
            for sequence in original_sequences:
                ...
                result_file.write(f"Розмір оригінальної послідовності: {str(len(source_bin))}\n")
                ...
                result_file.write(f"Розмір декодованих даних у бітах: {len(decoded) * 8}\n")
